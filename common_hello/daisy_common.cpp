...
void daisyCommon::add_knob(int user_name, int knob_num)
{
    switch(knob_num)
    {
        case knob_1: knob_1_user_name = user_name;
        case knob_2: knob_2_user_name = user_name;
        case knob_3: knob_3_user_name = user_name;
        case knob_4: knob_4_user_name = user_name;
        case knob_5: knob_5_user_name = user_name;
        case knob_6: knob_6_user_name = user_name;
        case knob_7: knob_7_user_name = user_name;
        case knob_8: knob_8_user_name = user_name;
        default: break;
    }
}
